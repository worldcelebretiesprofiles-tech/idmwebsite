        ...
        <div className="grid gap-12 pb-16 pt-20 lg:grid-cols-[1.4fr_1fr_1fr_1fr_1.2fr]">
          ...
          <div>
            ...
            <div className="mt-6 space-y-2 text-sm text-white/70">
              ...
              <p className="flex items-center gap-2"><Mail className="h-4 w-4 text-gold" /> <a href="mailto:info@idmsmarttech.com" className="hover:text-gold transition-colors">info@idmsmarttech.com</a></p>
