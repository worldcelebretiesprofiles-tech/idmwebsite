...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Spark Digital is a premium Digital Marketing & Technology Agency website that generates leads and builds trust." },
      { property: "og:description", content: "Spark Digital is a premium Digital Marketing & Technology Agency website that generates leads and builds trust." },
      { name: "twitter:description", content: "Spark Digital is a premium Digital Marketing & Technology Agency website that generates leads and builds trust." },
